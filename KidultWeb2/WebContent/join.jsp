...
<body>
	...
	<div class="container">
		...
		<hr>
		<center><h2 id="style_kidult">[ Join ]</h2></center>
		<hr>
		...
		<div class="row col-sm-10 col-sm-offset-1">
			...
			<form class="form-horizontal">
			  <div class="form-group">
			    <label for="inputText3" class="col-sm-4 control-label">이름</label>
			    <div class="col-sm-4">
			      <input type="text" class="form-control" id="inputText3" placeholder="이름">
			    </div>
			  </div>
			  <div class="form-group">
			...
			<div class="form-group">
			  ...
			  <div class="form-group">
			    <div class="col-sm-offset-5 col-sm-7">
			      <button type="submit" class="btn btn-warning" onclick="joinClick()">회원가입</button>
			    </div>
			  </div>
			</form>	
			<!-- write form end -->		
